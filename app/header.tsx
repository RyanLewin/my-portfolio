                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <a
                            key={link.name}
                            href={link.href}
                            className="text-sm text-foreground hover:text-gray-400 transition-colors"
                        >
                            {link.name}
                        </a>
                        ))}
                            ...
                            <nav className="flex flex-col gap-6 mt-8 mx-8">
                                ...
                                {navLinks.map((link) => (
                                    <a
                                        key={link.name}
                                        href={link.href}
                                        className="text-lg text-foreground hover:text-gray-400 active:text-gray-400 focus:text-gray-400 transition-colors"
                                    >
                                        {link.name}
                                    </a>
                                ))}
